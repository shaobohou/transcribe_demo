...
def test_session_logger_update_chunk_cleaned_text() -> None:
...
def test_session_logger_finalize_with_diff() -> None:
...
def test_session_logger_finalize_matching_transcripts() -> None:
...
def test_session_logger_finalize_without_diff() -> None:
